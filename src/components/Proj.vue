<template>
    ...
    <div class="maaain">
      ...
      <button type="submit" class="button1"  @click="showModal = true">Add project</button>
      <div>
        <div class="textname">
 ...
 <tr c v-for="proj in Projects" :key="proj.key">
                        <td class="td1"><p class="name">{{ proj.name }}</p></td>
                        <td class="td2"><p class="name1">{{ proj.team }}</p></td>
                        <td  class="td3"><p class="name2" >{{ proj.location}}</p></td>
                         <td class="td5"><p  class="name4">{{ proj.true }}</p></td>
                        <td class="td4">
                            
                           <p class="name3"><button class="butt1" @click.prevent="RoutTo(proj.key)" >About</button></p>
...
<form novalidate="true" @submit.prevent="onFormSubmit">
  <div class="modal" v-if="showModal">
        <p class="nttext">Create a new Project</p>
             ...
             <textarea type="text" class="inpname4" v-model="proj.description"></textarea>
    ...
    export default {
        ...
        methods: {
            onFormSubmit(event) {
                ...
                db.collection('proj').add(this.proj).then(() => {
            ...
            deleteUser(id){
             ...
             RoutTo(key){
               ...
               routes.push({ name: 'project', params: {
